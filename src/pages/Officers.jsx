...
export default function Officers() {
  // Officers data (no members added). Ethan and Brendan are Grade 10.
  const officers = [
    { id: 1, name: "Ethan Wu", role: "Co‑Founder", email: "wueth000@mysbisd.org", grade: 10 },
    { id: 2, name: "Brendan Liu", role: "Co‑Founder", email: "liubre000@mysbisd.org", grade: 10 },
