  ...
  return (
    <section style={{ padding: "56px 24px", background: "white" }}>
      <div style={{ maxWidth: 960, margin: "0 auto" }}>
        <Reveal><h2 style={{ fontSize: 36, fontWeight: 800, marginBottom: 8 }}>What is Ethics Bowl?</h2></Reveal>
        <Reveal delay={80}>
          <p style={{ color: "#334155", fontSize: 18, lineHeight: 1.6 }}>
            Ethics Bowl prepares emerging leaders and entrepreneurs in marketing, finance, hospitality, and management.
