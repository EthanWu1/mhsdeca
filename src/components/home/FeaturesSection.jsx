...
const items = [
  ...
  { title: "Professional Network", desc: "Connect with business professionals, alumni, and fellow DECA members to build lasting professional relationships.", icon: Briefcase },
  ...
  return (
    <section style={{ padding: "80px 24px", background: "white" }}>
      <div style={{ maxWidth: 1120, margin: "0 auto" }}>
        <Reveal><h2 style={{ fontSize: 40, fontWeight: 800, textAlign: "center", marginBottom: 12 }}>Why Join <span style={{ color: "#ef4444" }}>DECA</span>?</h2></Reveal>
